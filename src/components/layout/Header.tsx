    ...
    <>
      <header 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 md:px-12 py-4 ${
          isScrolled && !isMenuOpen ? 'bg-white/80 dark:bg-prussian-blue-500/80 backdrop-blur-md shadow-lg' : 'bg-transparent'
        }`}
      >
        <nav className="max-w-7xl mx-auto flex justify-between items-center relative z-50">
          ...
          <div className="flex items-center gap-2 md:hidden">
            ...
            <button 
              className="text-prussian-blue-500 dark:text-white p-2 relative z-[60]"
